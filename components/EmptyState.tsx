...
export function NoLedgerState({ onCreateLedger }: NoLedgerStateProps) {
    ...
    return (
        <EmptyState
            ...
            title={t.emptyState.noLedger.title}
            description={t.emptyState.noLedger.description}
            actionLabel={t.emptyState.noLedger.action}
...
export function NoTransactionState({ onAddTransaction }: NoTransactionStateProps) {
    ...
    return (
        <EmptyState
            ...
            title={t.emptyState.noTransaction.title}
            description={t.emptyState.noTransaction.description}
            actionLabel={t.emptyState.noTransaction.action}
